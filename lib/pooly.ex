defmodule Pooly do
  ...
  def start(_type, _args) do
    pools_config = [
      [name: "Pool 1", mfa: {Pooly.SampleWorker, :start_link, []}, size: 2],
      [name: "Pool 2", mfa: {Pooly.SampleWorker, :start_link, []}, size: 3],
      [name: "Pool 3", mfa: {Pooly.SampleWorker, :start_link, []}, size: 4]
    ]
